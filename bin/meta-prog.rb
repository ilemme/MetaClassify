...
# bei abbruch dran denken temporaere sample.txt und .._output_..txt datein aus 
# /work/gi/studprj/metaclassify/ zu entfernen
# bei neuverwendung des programms zuerst die calculate dateien aus metaclassify entfernen
require 'set'
...
def calculate(name, total)
  print "calculating distances, sensitivity and precision            \r"
...
def newick(name)
  ...
  print "removing temporary-file samples.txt                                      \r"
...
def megan(path, word, id_to_tax)
  ...
  print "creating temporary-file samples.txt including gold-taxid and megan-taxid\r"
...
def open_extern(id_to_tax, hash, map, var)
  print "creating hash: including read and gold-taxid                              \r"
